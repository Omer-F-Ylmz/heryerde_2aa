...
/// <summary>Gecede bir, saklama süresi dolan kişisel veriyi siler: 30 günden eski gönderilmiş/başarısız posta ve bir yıldan
/// eski iletişim mesajı (saklama süreleri: docs/veri-envanteri.md).</summary>
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (await timer.WaitForNextTickAsync(stoppingToken).ConfigureAwait(false))
        {
            try
            {
                ...
                _logger.LogInformation("Kişisel veri temizliği: {Mails} posta, {Messages} iletişim mesajı silindi.", mails, messages);
            }
